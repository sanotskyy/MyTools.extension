...
def natural_sort_key(text):
    """Розбиває номер листа на цифрові та нецифрові фрагменти, щоб
    "100" сортувався після "99", а не між "10" і "11" (як при звичайному
    порівнянні рядків)."""
    if text is None:
        text = u""
...
class SheetNumberForm(Form):
    ...
    def _refresh_sheets(self):
        ...
        if self.rb_sort_num.Checked:
            ...
            sheets = sorted(sheets, key=lambda s: natural_sort_key(s.Name))
